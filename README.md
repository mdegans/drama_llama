...
[![tests](https://img.shields.io/badge/tests-678-blue)](#testing)
...
678 tests across 30 binaries in the default configuration — 535 that run in
seconds and 143 that load real weights onto a real accelerator. The
