...
[![tests](https://img.shields.io/badge/tests-633-blue)](#testing)
...
633 tests across 28 binaries in the default configuration — 512 that run in
seconds and 121 that load real weights onto a real accelerator. The
