...
[![tests](https://img.shields.io/badge/tests-682-blue)](#testing)
...
682 tests across 30 binaries in the default configuration — 538 that run in
seconds and 144 that load real weights onto a real accelerator. The
