...
[![tests](https://img.shields.io/badge/tests-656-blue)](#testing)
...
656 tests across 29 binaries in the default configuration — 526 that run in
seconds and 130 that load real weights onto a real accelerator. The
