...
[![tests](https://img.shields.io/badge/tests-664-blue)](#testing)
...
664 tests across 29 binaries in the default configuration — 526 that run in
seconds and 138 that load real weights onto a real accelerator. The
