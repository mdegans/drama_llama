...
[![tests](https://img.shields.io/badge/tests-742-blue)](#testing)
...
742 tests across 31 binaries in the default configuration — 586 that run in
seconds and 156 that load real weights onto a real accelerator. The
