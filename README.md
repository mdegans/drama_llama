...
[![tests](https://img.shields.io/badge/tests-721-blue)](#testing)
...
721 tests across 31 binaries in the default configuration — 566 that run in
seconds and 155 that load real weights onto a real accelerator. The
