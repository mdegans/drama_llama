...
[![tests](https://img.shields.io/badge/tests-711-blue)](#testing)
...
711 tests across 30 binaries in the default configuration — 562 that run in
seconds and 149 that load real weights onto a real accelerator. The
