...
[![tests](https://img.shields.io/badge/tests-671-blue)](#testing)
...
671 tests across 30 binaries in the default configuration — 530 that run in
seconds and 141 that load real weights onto a real accelerator. The
