...
[![tests](https://img.shields.io/badge/tests-746-blue)](#testing)
...
746 tests across 31 binaries in the default configuration — 588 that run in
seconds and 158 that load real weights onto a real accelerator. The
