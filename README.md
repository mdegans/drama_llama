...
[![tests](https://img.shields.io/badge/tests-606-blue)](#testing)
...
606 tests across 27 binaries in the default configuration — 486 that run in
seconds and 120 that load real weights onto a real accelerator. The
